...
class LiveCollector:
    def __init__(self,tokens,root="runtime",mode="full"):
        self.tokens=tokens; self.store=AppendOnlyStore(root); self.builder=MinuteCandleBuilder(); self.sequence=0; self.token_to_contract={t:str(t) for t in tokens}; self.mode=mode; self.last_minute={}
