...
class BidAskFillModel:
    ...
    def fill(self, intent, quote):
        if quote is None or quote.last is None or quote.last <= 0: return None
        if quote.bid is None or quote.ask is None or quote.bid <= 0 or quote.ask <= 0 or quote.bid > quote.ask: return None
        if quote.bid > quote.last * 5 or quote.ask > quote.last * 5 or quote.ask < quote.last / 5: return None
